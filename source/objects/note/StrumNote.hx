	...
	public function reloadStrum(strumData:Int, ?assetModifier:String = "default"):StrumNote
	{
		...
		switch(assetModifier)
		{
			default:
				...
				{
					case 0:
						animation.addByPrefix('static', 'arrowLEFT', false);
						animation.addByPrefix('pressed', 'left press', 24, false);
						animation.addByIndices('confirm', 'left confirm', [0,1,2,3], "", 24, false);
					case 1:
						animation.addByPrefix('static', 'arrowDOWN', false);
						animation.addByPrefix('pressed', 'down press', 24, false);
						animation.addByIndices('confirm', 'down confirm', [0,1,2,3], "", 24, false);
					case 2:
						animation.addByPrefix('static', 'arrowUP', false);
						animation.addByPrefix('pressed', 'up press', 24, false);
						animation.addByIndices('confirm', 'up confirm', [0,1,2,3], "", 24, false);
					case 3:
						animation.addByPrefix('static', 'arrowRIGHT', false);
						animation.addByPrefix('pressed', 'right press', 24, false);
						animation.addByIndices('confirm', 'right confirm', [0,1,2,3], "", 24, false);
				}
		}
